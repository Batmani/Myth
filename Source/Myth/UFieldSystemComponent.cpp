#include "UFieldSystemComponent.h"
...
void UFieldSystemComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
    Super::TickComponent(DeltaTime, TickType, ThisTickFunction);
}

void UFieldSystemComponent::ApplyDamageToGeometryCollection(float Damage, float Radius, const FVector& Position)
{
